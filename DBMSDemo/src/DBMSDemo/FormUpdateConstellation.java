...
import static DBMSDemo.FormUpdateCelestialObject.RET_OK;
...
public class FormUpdateConstellation extends javax.swing.JDialog {
    ...
    public void setConstellation(Constellation constellation){
        ...
        txtType.setText(String.valueOf(constellation.getName()));
        txtDesignation.setText(String.valueOf(constellation.getArea()));
        txtMagnitude.setText(String.valueOf(constellation.getSymbol()));
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        int cID = constellation.getID();
        String cName = txtType.getName();
        int area = Integer.parseInt(txtDesignation.getText());
        String symbol = txtMagnitude.getText();
