...
public class FormViewMainSeq extends javax.swing.JInternalFrame {
    ...
    private MainSeqHandler cHandler = new MainSeqHandler();
    ...
    List<MainSeq> mainSeqs;
        ...
        mainSeqs = cHandler.loadMainSeq(keyword);
    ...
    private void tblCOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCOMouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            MainSeq mainSeq = mainSeqs.get(tblCO.getSelectedRow());
            //show form
