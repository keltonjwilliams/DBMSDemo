 ...
 * @author upadhyaya
 */
public class FormViewConstellation extends javax.swing.JInternalFrame {

    private ConstellationHandler cHandler = new ConstellationHandler();
    ...
    private void tblConstellationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblConstellationMouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            //show form
                        ...
                        formUpdateConstellations.setVisible(true);

                        if(formUpdateConstellations.getReturnStatus() == FormUpdateConstellation.RET_OK){
                                //refresh table
                                refreshTableConstellation();
                            }
        }
